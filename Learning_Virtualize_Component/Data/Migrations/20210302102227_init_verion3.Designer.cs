...
namespace Data.Migrations
{
    ...
    [Migration("20210302102227_init_verion3")]
    partial class init_verion3
    {
            ...
            modelBuilder.Entity("Models.Cluster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertDateTime = new DateTime(2021, 3, 2, 13, 52, 27, 220, DateTimeKind.Local).AddTicks(1835),
                            Name = "مدیریت توسعه پایدار"
                        },
                        new
                        {
                            Id = new Guid("f0bd5c41-4dc4-4c94-ab07-697d336bcdbd"),
                            InsertDateTime = new DateTime(2021, 3, 2, 13, 52, 27, 220, DateTimeKind.Local).AddTicks(3139),
                            Name = "مدیریت زیبوم"
                        },
                        new
                        {
                            Id = new Guid("69d98efe-e507-4e68-830e-021324eb2da8"),
                            InsertDateTime = new DateTime(2021, 3, 2, 13, 52, 27, 220, DateTimeKind.Local).AddTicks(3161),
                            Name = "مدیریت تجارت الکترونیک"
                        },
                        new
                        {
                            Id = new Guid("1b282c14-1616-447f-8f8f-f587c85ce97d"),
                            InsertDateTime = new DateTime(2021, 3, 2, 13, 52, 27, 220, DateTimeKind.Local).AddTicks(3170),
            ...
            modelBuilder.Entity("Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "محسن فرخی",
                            InsertDateTime = new DateTime(2021, 3, 2, 13, 52, 27, 213, DateTimeKind.Local).AddTicks(2479),
                            IsActive = true,
                            IsDeleted = false,
