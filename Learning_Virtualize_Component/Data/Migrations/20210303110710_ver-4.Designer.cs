...
namespace Data.Migrations
{
    ...
    [Migration("20210303110710_ver-4")]
    partial class ver4
    {
            ...
            modelBuilder.Entity("Models.Cluster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertDateTime = new DateTime(2021, 3, 3, 14, 37, 9, 663, DateTimeKind.Local).AddTicks(7700),
                            Name = "مدیریت توسعه پایدار"
                        },
                        new
                        {
                            Id = new Guid("f0bd5c41-4dc4-4c94-ab07-697d336bcdbd"),
                            InsertDateTime = new DateTime(2021, 3, 3, 14, 37, 9, 663, DateTimeKind.Local).AddTicks(9406),
                            Name = "مدیریت زیبوم"
                        },
                        new
                        {
                            Id = new Guid("69d98efe-e507-4e68-830e-021324eb2da8"),
                            InsertDateTime = new DateTime(2021, 3, 3, 14, 37, 9, 663, DateTimeKind.Local).AddTicks(9431),
                            Name = "مدیریت تجارت الکترونیک"
                        },
                        new
                        {
                            Id = new Guid("1b282c14-1616-447f-8f8f-f587c85ce97d"),
                            InsertDateTime = new DateTime(2021, 3, 3, 14, 37, 9, 663, DateTimeKind.Local).AddTicks(9440),
            ...
            modelBuilder.Entity("Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "محسن فرخی",
                            InsertDateTime = new DateTime(2021, 3, 3, 14, 37, 9, 656, DateTimeKind.Local).AddTicks(1569),
                            IsActive = true,
                            IsDeleted = false,
