...
namespace Data.Migrations
{
    ...
    [Migration("20210301120816_cluster_data")]
    partial class cluster_data
    {
            ...
            modelBuilder.Entity("Models.Cluster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6254bd26-f82e-4bfc-927a-bd6a590a089a"),
                            InsertDateTime = new DateTime(2021, 3, 1, 15, 38, 15, 722, DateTimeKind.Local).AddTicks(4194),
                            Name = "مدیریت توسعه پایدار"
                        },
                        new
                        {
                            Id = new Guid("8c4d1951-bd64-4b16-9835-7cfa744013b0"),
                            InsertDateTime = new DateTime(2021, 3, 1, 15, 38, 15, 722, DateTimeKind.Local).AddTicks(5566),
                            Name = "مدیریت زیبوم"
                        },
                        new
                        {
                            Id = new Guid("aa966bbc-8c7f-447a-b20b-4b329fa38908"),
                            InsertDateTime = new DateTime(2021, 3, 1, 15, 38, 15, 722, DateTimeKind.Local).AddTicks(5585),
                            Name = "مدیریت تجارت الکترونیک"
                        },
                        new
                        {
                            Id = new Guid("19f4a5ac-09a9-4f18-ac11-57f3017a4c9e"),
                            InsertDateTime = new DateTime(2021, 3, 1, 15, 38, 15, 722, DateTimeKind.Local).AddTicks(5650),
            ...
            modelBuilder.Entity("Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d06ab9be-ce41-4626-bb33-d52d62614bca"),
                            CellPhoneNumber = "09120717168",
                            FullName = "محسن فرخی",
                            InsertDateTime = new DateTime(2021, 3, 1, 15, 38, 15, 713, DateTimeKind.Local).AddTicks(2396),
                            IsActive = true,
                            IsDeleted = false,
