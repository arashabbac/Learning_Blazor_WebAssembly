...
namespace Data.Migrations
{
    ...
    [Migration("20210303101807_Indicators")]
            ...
            modelBuilder.Entity("Models.Cluster", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertDateTime = new DateTime(2021, 3, 3, 13, 48, 6, 441, DateTimeKind.Local).AddTicks(8431),
                            Name = "مدیریت توسعه پایدار"
                        },
                        new
                        {
                            Id = new Guid("f0bd5c41-4dc4-4c94-ab07-697d336bcdbd"),
                            InsertDateTime = new DateTime(2021, 3, 3, 13, 48, 6, 442, DateTimeKind.Local).AddTicks(114),
                            Name = "مدیریت زیبوم"
                        },
                        new
                        {
                            Id = new Guid("69d98efe-e507-4e68-830e-021324eb2da8"),
                            InsertDateTime = new DateTime(2021, 3, 3, 13, 48, 6, 442, DateTimeKind.Local).AddTicks(138),
                            Name = "مدیریت تجارت الکترونیک"
                        },
                        new
                        {
                            Id = new Guid("1b282c14-1616-447f-8f8f-f587c85ce97d"),
                            InsertDateTime = new DateTime(2021, 3, 3, 13, 48, 6, 442, DateTimeKind.Local).AddTicks(147),
            ...
            modelBuilder.Entity("Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "محسن فرخی",
                            InsertDateTime = new DateTime(2021, 3, 3, 13, 48, 6, 434, DateTimeKind.Local).AddTicks(5771),
                            IsActive = true,
                            IsDeleted = false,
